...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Jan-2023 às 14:43
...
--
-- Banco de dados: `projeto_4_colegio`
--
...
(1, 2100, 'Beatriz', 'Rua Alvorada 467', 2147483647),
(2, 1800, 'Thamilliz', 'Rua Benedita 986', 2147483647),
(3, 1700, 'Vanessa', 'Rua Pedro de Carvalho', 2147483647);
...
CREATE TABLE `disciplina` (
  ...
  `Nome_Disc` varchar(300) DEFAULT NULL,
...
INSERT INTO `disciplina` (`Cod_Disc`, `Nome_Disc`, `Cod_Prof`) VALUES
(1, 'Fundamentos da Programação', 2),
(2, 'Ciência da Computação', 1),
(3, 'Computação em Nuvem', 2),
(4, 'Internet das Coisas', 3);
...
(1, 'André Malina', 'M', 'Filosofia da Computação'),
(2, 'Ricardo Lucatelli', 'M', 'Diagnóstico da Computação'),
(3, 'Michelle Fonceca', 'F', 'Fundamentos do Hadware');
...
CREATE TABLE `responsaveis` (
  ...
  `Cpf` varchar(11) NOT NULL DEFAULT 'NULL',
...
INSERT INTO `responsaveis` (`Cod_Resp`, `Cod_Aluno`, `Nome`, `Cpf`, `Tel`) VALUES
(1, 1, 'Marinalva Vallesk da Fonseca', '14579215238', '21987994428'),
(2, 2, 'Ana Benta da Costa', '32156444536', '2476153481'),
(3, 3, 'Veronica Ferreira Jardim', '23317786649', '22986247578');
...
INSERT INTO `turma` (`Cod_Turma`, `Cod_Disc`, `Cod_Curso`, `Cod_Aluno`) VALUES
(1, 4, 1, 1),
(2, 3, 2, 2),
(3, 2, 1, 1),
(4, 1, 2, 1);
...
--
ALTER TABLE `disciplina`
  MODIFY `Cod_Disc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `responsaveis`
  MODIFY `Cod_Resp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `responsaveis`
  ADD CONSTRAINT `responsaveis_ibfk_1` FOREIGN KEY (`Cod_Aluno`) REFERENCES `aluno` (`Cod_Aluno`);
